...
class MigradorCSVParaSQLite:
    ...
    def migrar_jogadores(self):
        ...
        csv_path = os.path.join(self.csv_dir, 'jogadores.csv')
        if not os.path.exists(csv_path):
    ...
    def migrar_treinadores(self):
        ...
        csv_path = os.path.join(self.csv_dir, 'treinadores.csv')
        if not os.path.exists(csv_path):
    ...
    def migrar_arbitros(self):
        ...
        csv_path = os.path.join(self.csv_dir, 'arbitros.csv')
        if not os.path.exists(csv_path):
    ...
    def migrar_partidas(self):
        ...
        csv_path = os.path.join(self.csv_dir, 'partidas.csv')
        if not os.path.exists(csv_path):
...
if __name__ == "__main__":
    ...
    CAMINHO_BANCO_SQLITE = "C:/Users/enryk/Documents/Estudos/kamusari/novo_bd1971_robusto/bd/estruturado_bd_1971.db"  # Seu arquivo .db
    DIRETORIO_CSVS = "C:/Users/enryk/Documents/Estudos/kamusari/novo_bd1971_robusto/csv_atualizados"  # Pasta com os CSVs
