...
class OGolScraperRelacional:
    ...
    def processar_clube(self, url_clube):
        ...
        dados = {}
        for div in container.find_all("div", class_=["card-data__label", "card-data__value"]):
            span = div.find("span")
            if not span:
                continue
...
if __name__ == "__main__":
    ...
    url_base = "https://www.ogol.com.br/edicao/copa-brasil-1975/2491/calendario?equipa=0&estado=1&filtro=&op=calendario&page="
