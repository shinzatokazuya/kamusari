...
class OGolScraperRelacional:
    ...
    def executar(self, edicao_id=1, page_atual=1, page_maxima=1):
        ...
        for linha in tabela.find_all("tr"):
            ...
            link_partida = self._extrair_link(celulas[5])
...
if __name__ == "__main__":
    ...
    url_base = "https://www.ogol.com.br/edicao/copa-brasil-1976/4002/calendario?fase_in=0&equipa=0&estado=1&filtro=&op=calendario&page="
